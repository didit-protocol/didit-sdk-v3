...
function getDiditThemeVariables(themeVariables?: ThemeVariables, themeType?: ThemeType) {
  if (themeType === 'light') {
    return {
      '--dd-accent': themeVariables?.['--dd-accent'] || 'hsla(231, 100%, 70%, 1)',
      '--dd-background': '#fff'
    }
  }

  return {
    '--dd-accent': themeVariables?.['--dd-accent'] || 'hsla(230, 100%, 67%, 1)',
    '--dd-background': '#121313'
  }
}
...
function createRootStyles(themeVariables?: ThemeVariables) {
  return {
    core: css`
      ...
      :root {
        ...
        --w3m-color-mix-strength: ${unsafeCSS(
          themeVariables?.['--dd-color-mix-strength']
            ? `${themeVariables['--dd-color-mix-strength']}%`
            : '0%'
        )};
        --w3m-font-family: ${unsafeCSS(
          themeVariables?.['--dd-font-family'] ||
            'Inter, Segoe UI, Roboto, Oxygen, Ubuntu, Cantarell, Fira Sans, Droid Sans, Helvetica Neue, sans-serif;'
        )};
        --w3m-font-size-master: ${unsafeCSS(themeVariables?.['--dd-font-size-master'] || '10px')};
        --w3m-border-radius-master: ${unsafeCSS(
          themeVariables?.['--dd-border-radius-master'] || '4px'
        )};
        --w3m-z-index: ${unsafeCSS(themeVariables?.['--dd-z-index'] || 999)};
    ...
    light: css`
      :root {
        --w3m-color-mix: ${unsafeCSS(themeVariables?.['--dd-color-mix'] || '#fff')};
        --w3m-accent: ${unsafeCSS(getDiditThemeVariables(themeVariables, 'dark')['--dd-accent'])};
        --w3m-default: #fff;

        --wui-color-modal-bg-base: ${unsafeCSS(
          getDiditThemeVariables(themeVariables, 'dark')['--dd-background']
        )};
    ...
    dark: css`
      :root {
        --w3m-color-mix: ${unsafeCSS(themeVariables?.['--dd-color-mix'] || '#000')};
        --w3m-accent: ${unsafeCSS(getDiditThemeVariables(themeVariables, 'light')['--dd-accent'])};
        --w3m-default: #000;

        --wui-color-modal-bg-base: ${unsafeCSS(
          getDiditThemeVariables(themeVariables, 'light')['--dd-background']
        )};
        --wui-color-accent-base-100: var(--w3m-accent);
